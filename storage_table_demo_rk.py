...
resourcegroup_name = 'ruchitk'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'ruchitk'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
car.make = 'Audi'
car.model = '2014'
car.color='Silver-Grey'
car.cost = 41000
table_service.insert_entity('itemstable', car)
print('Created entry for Audi...\n')
...
flavors = table_service.query_entities('itemstable', filter="PartitionKey eq 'cardealership'", select='make,cost')
for flavor in flavors:
    print('Name: ' + flavor.make)
    print('Cost: ' + str(flavor.cost) + '\n')

flavors = table_service.query_entities('itemstable', filter="PartitionKey eq 'coffeeshop'", select='brand,cost')
for flavor in flavors:
    print('Name: ' + flavor.brand)
    print('Price: ' + str(flavor.cost) + '\n')
